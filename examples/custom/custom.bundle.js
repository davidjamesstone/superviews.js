...
elementOpen("input", "9f03dd91-5891-4e86-8f12-2ac34fa3a900", hoisted1, "value", data.name, "onkeyup", this.onChange.bind(this))
elementClose("input")
elementOpen("span")
  text("" + (data.name) + "")
elementClose("span")
...
module.exports = function description (data) {
elementOpen("form")
  elementOpen("input", "a083dda5-a8ad-433d-8672-dbcf35e55b4a", hoisted1, "value", data.name)
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
  elementOpen("x-sub", "1a955304-0059-4f75-8e8f-7df04420b241", hoisted2)
    if (true) {
      skip()
    } else {
    }
  elementClose("x-sub")
  elementOpen("a", "d89ce210-85e4-4cf9-beb4-48e1a5767029", hoisted3)
    text("Google")
  elementClose("a")
  __target = data.list
  if (__target) {
    ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
      var item = $value
      var $key = "27e0e047-263a-4262-a329-ab8e16d4ace2_" + $item
