...
module.exports = function a (data, b) {
  elementOpen("main")
...
},{"../../client":1,"./a.html":3,"./b":6}],5:[function(require,module,exports){
var IncrementalDOM = require('incremental-dom')
var patch = IncrementalDOM.patch
var elementOpen = IncrementalDOM.elementOpen
var elementClose = IncrementalDOM.elementClose
...
elementOpen("form")
  elementOpen("input", "80774938-8574-4780-a5ae-6b6de2ae3192", hoisted1, "value", data.name, "onkeyup", this.onChange.bind(this))
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
...
},{"incremental-dom":8}],6:[function(require,module,exports){
var superviews = require('../../client')
...
},{"../../client":1,"./b.html":5}],7:[function(require,module,exports){
...
},{"../../client/patch":2,"./a":4}],8:[function(require,module,exports){
