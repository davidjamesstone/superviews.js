    ...
    elementOpen("ul")
      ...
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var item = $value
          var $key = "03034894-4407-4b12-ad7c-34c9ccbc351d_" + $item
          elementOpen("li", $key)
            b(item)
          elementClose("li")
        }, this)
...
elementOpen("form")
  elementOpen("input", "0f3eb155-991a-4fb2-9f00-65a44b8cc631", hoisted1, "value", data.name, "onkeyup", this.onChange.bind(this))
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
