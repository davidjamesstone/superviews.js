...
elementOpen("div")
  elementOpen("hr")
  elementClose("hr")
  elementOpen("input", "dae1eac0-34c9-4ad2-ba98-e5d88ad28b06", hoisted1, "value", data.name, "onkeyup", this.onChange)
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
...
module.exports = function parent (data1, todos, child) {
  elementOpen("form")
    elementOpen("input", "f4f5d7bd-6455-42e8-89f0-1518dabb57ad", hoisted1, "value", data1.name, "onkeyup", this.onChange)
    elementClose("input")
    elementOpen("span")
      text("" + (data1.name) + "")
    elementClose("span")
    elementOpen("a", "e51d367b-8888-4188-8591-1146bd4c8a96", hoisted2)
      text("Google")
    elementClose("a")
    elementOpen("ul")
      __target = todos
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var todo = $value
          var $key = "91e35362-6d94-4a8c-843a-f902b84c2ea0_" + $item
          elementOpen("li", $key)
            text("" + (todo.text) + "")
          elementClose("li")
        }, this)
    ...
    elementOpen("ul")
      ...
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var item = $value
          var $key = "8cb74efb-dfe6-46b7-b331-20ff103fc512_" + $item
          elementOpen("li", $key)
            child(item)
          elementClose("li")
        }, this)
