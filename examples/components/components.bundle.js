...
},{"./patch":2,"incremental-dom":8}],2:[function(require,module,exports){
var IncrementalDOM = require('incremental-dom')
...
},{"incremental-dom":8}],3:[function(require,module,exports){
var IncrementalDOM = require('incremental-dom')
var patch = IncrementalDOM.patch
var elementOpen = IncrementalDOM.elementOpen
var elementClose = IncrementalDOM.elementClose
...
elementOpen("form")
  elementOpen("input", "ba929080-a27e-4fe6-8fa3-bda71d095471", hoisted1, "value", data.name, "onkeyup", this.onChange.bind(this))
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
...
},{"incremental-dom":8}],4:[function(require,module,exports){
...
},{"../../client":1,"./child.html":3}],5:[function(require,module,exports){
...
},{"../../client/patch":2,"./parent":7}],6:[function(require,module,exports){
var IncrementalDOM = require('incremental-dom')
var patch = IncrementalDOM.patch
var elementOpen = IncrementalDOM.elementOpen
var elementClose = IncrementalDOM.elementClose
...
module.exports = function description (data, child) {
  elementOpen("main")
    elementOpen("h1", null, null, "onclick", this.onClick)
      text("" + (data.aData.title) + "")
    elementClose("h1")
    elementOpen("article")
      text(" \
            Egg \
            ")
      b(data.bData)
    elementClose("article")
    elementOpen("ul")
      __target = data.list
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var item = $value
          var $key = "366769e8-b3a2-4ab1-bd74-92be60bb15e2_" + $item
          elementOpen("li", $key)
            child(item)
          elementClose("li")
        }, this)
      ...
      elementOpen("li")
        elementOpen("button", null, null, "onclick", this.addItem.bind(this))
          text("Add")
        elementClose("button")
      elementClose("li")
    elementClose("ul")
...
},{"incremental-dom":8}],7:[function(require,module,exports){
var superviews = require('../../client')
...
},{"../../client":1,"./child":4,"./parent.html":6}],8:[function(require,module,exports){
