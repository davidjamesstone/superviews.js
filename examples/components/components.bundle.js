...
elementOpen("hr")
elementClose("hr")
elementOpen("input", "137165c8-7e81-435b-83ae-d4f0c41aac9b", hoisted1, "value", data.name, "onkeyup", this.onChange.bind(this))
elementClose("input")
elementOpen("span")
  text("" + (data.name) + "")
elementClose("span")
...
module.exports = function parent (data1, todos, child) {
  elementOpen("form")
    elementOpen("input", "5138745a-30ec-4f77-a0ad-a669d8a69cfb", hoisted1, "value", data1.name, "onkeyup", this.onChange.bind(this))
    elementClose("input")
    elementOpen("span")
      text("" + (data1.name) + "")
    elementClose("span")
    elementOpen("a", "e0eb082f-395a-43aa-8716-9ac2b34133ea", hoisted2)
      text("Google")
    elementClose("a")
    elementOpen("ul")
      __target = todos
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var todo = $value
          var $key = "c1b3a9d1-6aa8-4d1a-92d1-644cb9f8bc0b_" + $item
          elementOpen("li", $key)
            text("" + (todo.text) + "")
          elementClose("li")
        }, this)
    ...
    elementOpen("ul")
      ...
      if (__target) {
        ;(__target.forEach ? __target : Object.keys(__target)).forEach(function($value, $item, $target) {
          var item = $value
          var $key = "fc987714-e0b3-4d2d-93b5-349b62256910_" + $item
          elementOpen("li", $key)
            child(item)
          elementClose("li")
        }, this)
