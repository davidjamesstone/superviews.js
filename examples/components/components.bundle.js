...
},{"incremental-dom":8}],2:[function(require,module,exports){
var IncrementalDOM = require('incremental-dom')
...
elementOpen("form")
  elementOpen("input", "1ed19c4d-64e7-48cc-8426-4cba9b61c188", hoisted1, "value", data.name, "onchange", this.onChange.bind(this))
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
