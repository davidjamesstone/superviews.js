...
elementOpen("form")
  elementOpen("input", "33549d3b-ab70-490e-bc62-03c4c81066fe", hoisted1, "value", data.name, "onchange", this.onChange.bind(this))
  elementClose("input")
  elementOpen("span")
    text("" + (data.name) + "")
  elementClose("span")
